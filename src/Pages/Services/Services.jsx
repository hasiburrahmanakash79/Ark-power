  ...
  return (
    <div className=" container mx-auto p-6">
      ...
      <h1 className="text-balance">
        ...
        (UPS), available in modular and tower configurations, offer reliable
        backup power solutions, ensuring continuity and safety for sensitive
        electronic devices and systems. The Automatic Voltage Regulator (AVR)
        ...
        Transformers are key in adjusting voltage levels in power distribution,
        ...
        outages or in remote locations, ensuring a continuous power supply where
        ...
        applications, contributing to the efficiency, safety, and sustainability
        of electrical and electronic systems worldwide.
      </h1>
    </div>
    </div>
  );
