...
const EditFooter = () => {
  ...
  const handleSave = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        Swal.fire(
          "Updated!",
          "The footer information has been updated.",
          "success"
        );
      } else {
  ...
  return (
    <form
      onSubmit={handleSave}
      className="w-full max-w-7xl mx-auto p-4 bg-white rounded-lg shadow-lg"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Social Media Fields */}
        {["facebook", "youtube", "instagram", "twitter", "telegram"].map(
          (platform) => (
            <div key={platform}>
              <label
                className="block text-gray-700 text-sm font-medium mb-1"
